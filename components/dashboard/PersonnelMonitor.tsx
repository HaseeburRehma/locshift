    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center h-64 space-y-4">
                ...
                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Syncing Personnel Status...</p>
            </div>
        )
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <Card className="p-8 rounded-[2.5rem] bg-slate-900 border-none text-white relative overflow-hidden group shadow-2xl col-span-1 md:col-span-2">
                    ...
                    <div className="relative z-10 space-y-6">
                        <h3 className="text-[11px] font-black uppercase tracking-[0.3em] text-blue-400">LIVE PERSONNEL STATUS</h3>
                        <div className="flex items-end gap-3 font-black tracking-tighter">
                            ...
                            <span className="text-2xl text-slate-400 pb-2 uppercase tracking-widest">Active</span>
                        </div>
                ...
                <Card className="p-8 rounded-[2.5rem] bg-white border border-slate-100 shadow-sm flex flex-col justify-between group hover:border-emerald-200 transition-all">
                    <div className="space-y-4">
                        <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">ON MISSION</h3>
                    ...
                    <div className="pt-6 flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 leading-none">Operational Capacity</span>
                    </div>
                </Card>
                ...
                <Card className="p-8 rounded-[2.5rem] bg-white border border-slate-100 shadow-sm flex flex-col justify-between group hover:border-amber-200 transition-all">
                    <div className="space-y-4">
                        <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">ON STANDBY / BREAK</h3>
                    ...
                    <div className="pt-6 flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 leading-none">Resource Buffer</span>
                    </div>
                </Card>
            </div>
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between px-6">
                    ...
                    <div className="flex items-center gap-2 text-[9px] font-black text-blue-600 bg-blue-50 px-3 py-1 rounded-full uppercase tracking-widest animate-pulse">
                        <div className="w-1.5 h-1.5 rounded-full bg-blue-600" /> Live Operational Sync
                    </div>
                </div>
                        ...
                        >
                            <div className="flex flex-col h-full space-y-8">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <Badge className={cn(
                                                ...
                                                {shift.is_on_break ? 'On Break' : 'On Mission'}
                                            </Badge>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-slate-50/50 rounded-2xl p-6 border border-slate-100 space-y-4">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2 text-slate-400">
                                            ...
                                            <span className="text-[10px] font-black uppercase tracking-widest">Engaged For</span>
                                        </div>
                                ...
                                <div className="mt-auto pt-4 flex gap-3">
                                    <Button variant="ghost" className="flex-1 h-12 rounded-xl text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-blue-600 hover:bg-blue-50 border border-slate-50 transition-all">
                                        Contact Agent
                                    </Button>
                                    <Button className="flex-1 h-12 rounded-xl text-[10px] font-black uppercase tracking-widest bg-slate-900 hover:bg-black text-white shadow-xl shadow-slate-100 transition-all active:scale-95">
                                        View Audit
                                    </Button>
                                </div>
                            </div>
                    ...
                    {activeShifts.length === 0 && (
                        <div className="col-span-full py-24 bg-slate-50/30 rounded-[3rem] border-2 border-dashed border-slate-100 flex flex-col items-center justify-center text-center space-y-6">
                            ...
                            <div className="space-y-2">
                                <p className="text-xl font-bold text-slate-900 tracking-tight">No Active Missions</p>
                                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 max-w-sm px-6">
                                    Operational workforce is currently in standby mode (Section 4.2).
                                </p>
                            </div>
                            <Button variant="ghost" className="font-black text-[10px] uppercase tracking-widest text-blue-600 gap-2">
                                Access Daily Deployment <ArrowRight className="h-3 w-3" />
                            </Button>
                        </div>
                    )}
                </div>
