...
export default function AuthCodeErrorContent() {
  ...
  // Read directly — no useEffect/useState round-trip needed. The Suspense
  // boundary in the parent ensures Next.js doesn't try to prerender this
  // synchronously without params.
